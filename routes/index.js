            ...
            req.logIn(user, function (err) {
                ...
                async function sendVerificationEmail(user) {
                    ...
                    const data = {
                        from: `Weryfikacja konta 5zeta.pl <verification@5zeta.pl>`,
                        to: `${Base64.decode(user.email)}`,
                        subject: `Potwierdź swoją tożsamość`,
                        html: `<html>
                                        <head>
                                        ...
                                        <body>
                                            <p class="description">
                                                ...
                                                <br>
                                                Zanim będziesz mógł przeglądać swoje ogłoszenia lub dodawać nowe
                                                chcemy mieć pewność, że to ty. Prosimy wpisz na stronie poniższy kod weryfikacyjny.
                                                <br>
                                                <br>
                ...
                return res.redirect(`/user/${user._id}/two-factor`);
            });
        } else {
