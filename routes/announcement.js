...
function sanitizeHTMLWithOptions(value){
    return sanitizeHTML(value, {
        allowedTags: ["strong", "em", "i", "b", "ins", "del"]
    })
}
...
router.post("/", upload.single("profile"), isLoggedIn, (req, res) => {
    cloudinary.uploader.upload(req.file.path, function(result) {
        let newAnnouncement = new Announcement({
            ...
            description: sanitizeHTMLWithOptions(req.body.description),
            type: req.body.type,
            author: req.user._id,
            category: req.body.category,
            profile: result.secure_url,
            price: req.body.price,
            link: sanitizeHTML(req.body.title).toLowerCase().split(' ').join('-'),
            keywords: sanitizeHTML(req.body.keywords)
        })
...
router.put("/:announcement_id", isLoggedIn, (req, res) => {
    Announcement.findByIdAndUpdate(req.params.announcement_id, req.body.announcement, (err, updatedAnnouncement) => {
        if(err){
            ...
            updatedAnnouncement.link = sanitizeHTML(req.body.announcement.title).toLowerCase().split(' ').join('-');
            updatedAnnouncement.description = sanitizeHTMLWithOptions(req.body.announcement.description);
            updatedAnnouncement.title = sanitizeHTML(req.body.announcement.title);
            updatedAnnouncement.keywords = sanitizeHTML(req.body.announcement.keywords);
